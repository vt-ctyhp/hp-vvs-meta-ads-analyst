...
function compactDashboard(dashboard: DashboardPayload) {
  return {
    ...
    topCreatives: dashboard.creatives.slice(0, 16).map((creative) => ({
      ...
      websiteBookings: creative.websiteBookings,
      messagingContacts: creative.messagingContacts,
      newMessagingContacts: creative.newMessagingContacts,
      primaryResults: creative.primaryResults,
      primaryResultLabel: creative.primaryResultLabel,
      secondaryResults: creative.secondaryResults,
      secondaryResultLabel: creative.secondaryResultLabel,
      costPerPrimaryResult: creative.costPerPrimaryResult,
      cpl: creative.cpl,
