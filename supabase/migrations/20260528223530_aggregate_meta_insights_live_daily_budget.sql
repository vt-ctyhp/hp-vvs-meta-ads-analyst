-- Keep aggregate_meta_daily_insights daily_budget limited to live budget entities.
--
...
as $$
  ...
  grouped as (
    select
      ...
      round(sum(case when r.daily_budget_rank = 1 and r.delivery_status = 'live' and r.daily_budget > 0 then r.daily_budget else 0 end), 2) as daily_budget,
